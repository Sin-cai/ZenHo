...
<body>
                ...
                <table cellpadding="5">
                    <tr>
                        ...
                        <td>
                            <select name="id" id="id">
                                ...
                                <?php
                                include "../koneksi.php";
                            $query = "SELECT * FROM userr WHERE ID_T=1" ;
                  ...
                  ?>
                    ...
                    <tr>
                        <td>Jumlah kamar</td>
                        <td>
                            <input type="number" name="ruang" id="ruang" oninput="hitungHasil()" />
                        </td>
                    </tr>
                    <tr>
                        <td>Lama Inap</td>
    ...
    kasur.addEventListener('change', function() {
        ...
        <?php
          ...
          WHERE checkout.id_RS IS NULL OR history.id_his IS NOT NULL;";
          $result = mysqli_query($koneksi, $query);
          $first = true;
          $jenisSelec = "";
          if (!empty($_GET['id_1'])) {
    ...
    $("#submit-booking").click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "input_reservasi.php", // Adjust the path
            data: {
                id: id,
                orang: orang,
                ruang: ruang,
